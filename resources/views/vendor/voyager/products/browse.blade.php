...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add',app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}?type=2" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>New Tour</span>
            </a>
        @endcan
        @can('add',app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}?type=1" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>New Event</span>
            </a>
        @endcan
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        <?php $showInputs=array("name","price","quantity","product_belongsto_type_relationship","start_date","end_date","start_hour","end_hour","product_belongsto_region_relationship") ?>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            @if(in_array($row->field,$showInputs))
